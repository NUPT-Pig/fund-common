...
public class CommonResponse {
    ...
    public static <T> ResponseEntity<CommonResult<Object>> ok(HttpStatus httpStatus){
    ...
    public static <T> ResponseEntity<CommonResult<Object>> fail(HttpStatus httpStatus){
